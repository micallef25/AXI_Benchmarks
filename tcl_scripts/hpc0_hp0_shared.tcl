...
xilinx.com:hls:example_rx:1.0\
xilinx.com:hls:example_tx:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: example_rx_0, and set properties
  set example_rx_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:example_rx:1.0 example_rx_0 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM0_CACHE_VALUE {"0011"} \
 ] $example_rx_0

  # Create instance: example_rx_1, and set properties
  set example_rx_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:example_rx:1.0 example_rx_1 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM0_CACHE_VALUE {"1111"} \
 ] $example_rx_1

  # Create instance: example_tx_0, and set properties
  set example_tx_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:example_tx:1.0 example_tx_0 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM0_CACHE_VALUE {"0011"} \
 ] $example_tx_0

  # Create instance: example_tx_1, and set properties
  set example_tx_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:example_tx:1.0 example_tx_1 ]
  set_property -dict [ list \
   CONFIG.C_M_AXI_GMEM0_CACHE_VALUE {"1111"} \
 ] $example_tx_1
  ...
  connect_bd_intf_net -intf_net example_rx_0_m_axi_gmem0 [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins example_rx_0/m_axi_gmem0]
connect_bd_intf_net -intf_net [get_bd_intf_nets example_rx_0_m_axi_gmem0] [get_bd_intf_pins axi_perf_mon_0/SLOT_1_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net example_rx_1_m_axi_gmem0 [get_bd_intf_pins example_rx_1/m_axi_gmem0] [get_bd_intf_pins smartconnect_2/S01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets example_rx_1_m_axi_gmem0] [get_bd_intf_pins axi_perf_mon_0/SLOT_5_AXI] [get_bd_intf_pins smartconnect_2/S01_AXI]
  connect_bd_intf_net -intf_net example_tx_0_m_axi_gmem0 [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins example_tx_0/m_axi_gmem0]
connect_bd_intf_net -intf_net [get_bd_intf_nets example_tx_0_m_axi_gmem0] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/S01_AXI]
  connect_bd_intf_net -intf_net example_tx_0_stream_out [get_bd_intf_pins example_rx_0/stream_in] [get_bd_intf_pins example_tx_0/stream_out]
  connect_bd_intf_net -intf_net example_tx_1_m_axi_gmem0 [get_bd_intf_pins example_tx_1/m_axi_gmem0] [get_bd_intf_pins smartconnect_2/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets example_tx_1_m_axi_gmem0] [get_bd_intf_pins axi_perf_mon_0/SLOT_4_AXI] [get_bd_intf_pins smartconnect_2/S00_AXI]
  connect_bd_intf_net -intf_net example_tx_1_stream_out [get_bd_intf_pins example_rx_1/stream_in] [get_bd_intf_pins example_tx_1/stream_out]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins example_rx_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins example_tx_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins axi_perf_mon_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins example_tx_1/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins example_rx_1/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins smartconnect_2/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net example_rx_0_interrupt [get_bd_pins example_rx_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_1_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_2_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_3_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_4_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_5_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_6_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_7_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins example_rx_0/ap_rst_n] [get_bd_pins example_rx_1/ap_rst_n] [get_bd_pins example_tx_0/ap_rst_n] [get_bd_pins example_tx_1/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces example_rx_0/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces example_rx_0/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces example_rx_1/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces example_rx_1/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces example_tx_0/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces example_tx_0/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces example_tx_1/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces example_tx_1/Data_m_axi_gmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_perf_mon_0/S_AXI/Reg] SEG_axi_perf_mon_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] SEG_axi_timer_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_rx_0/s_axi_control/Reg] SEG_example_rx_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_rx_1/s_axi_control/Reg] SEG_example_rx_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_tx_0/s_axi_control/Reg] SEG_example_tx_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0070000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs example_tx_1/s_axi_control/Reg] SEG_example_tx_1_Reg
